...
paragraph2vec_train <- function(trainFile, embeddings, size = 100L, cbow = 1L, hs = 0L, negative = 5L, iterations = 5L, window = 5L, alpha = 0.05, sample = 0.001, min_count = 5L, threads = 1L, trace = 0L) {
    .Call('_doc2vec_paragraph2vec_train', PACKAGE = 'doc2vec', trainFile, embeddings, size, cbow, hs, negative, iterations, window, alpha, sample, min_count, threads, trace)
}
